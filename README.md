...
<p align="center">
  <img src="https://img.shields.io/badge/Status-Em_Prototipa%C3%A7%C3%A3o-yellow" alt="Status do Projeto: Em Prototipação">
  <img src="https://img.shields.io/badge/Projeto-Acad%C3%AAmico_(Dev_%C3%81gil)-blue" alt="Projeto Acadêmico">
  <a href="https://gabrielriul.github.io/DivideAi/Prototipa%C3%A7%C3%A3o/Prot%C3%B3tipo.html">
    <img src="https://img.shields.io/badge/Prot%C3%B3tipo-Online-brightgreen" alt="Ver Protótipo Online">
  </a>
</p>
...
- [🛠️ Ferramentas e Conceitos](#️-ferramentas-e-conceitos)
- [👥 Autores](#-autores)
...
O **DivideAí** é um protótipo de aplicativo focado na gestão de repúblicas estudantis. A ideia é criar um app simples para ajudar estudantes que moram juntos a organizar tarefas domésticas, despesas compartilhadas e comunicação.

Este repositório foi criado para a disciplina de **Desenvolvimento Ágil (2025, 2º Semestre)**, com o objetivo principal de aplicar e aprender na prática os conceitos de **Git**, **GitHub** (como branches, Pull Requests, CI/CD) e **metodologias ágeis** (Scrum, User Stories, etc.).

## ✨ Funcionalidades

O escopo do protótipo cobre as seguintes funcionalidades principais:

* 🔐 **Autenticação:** Cadastro e Login de usuários.
* 🏠 **Gestão de Repúblicas:** Criar uma nova república ou vincular-se a uma existente.
* 🧹 **Gestão de Tarefas:** Criação, atribuição e "check" de tarefas domésticas.
* 💸 **Gestão de Cobranças:** Cadastro de despesas, divisão automática de valores e visualização de débitos.
* 💬 **Chat Interno:** Um chat para comunicação entre os membros da república.
